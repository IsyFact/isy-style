...
Implementiert einen interaktiven xref:glossary:literaturextern:inhalt.adoc#litextern-eternicode-boostsrap-date-picker[Standard Date Picker]
...
Implementiert einen interaktiven xref:glossary:literaturextern:inhalt.adoc#litextern-jdewit-boostsrap-time-picker[Standard Time Picker]
...
[[listing-isy-style-less]]
.Einbinden der Stylesheets von isy-style in Angular Projekt
[source,less]
----
...
[[listing-isy-style-angular]]
.Bereitstellen von statischen Ressourcen aus isy-style in Angular Projekten
[source,json]
----
{
 "projects": {
