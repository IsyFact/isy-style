...
TIP: Die JSP WebGui Demoanwendung im Package `isy-webgui` wird kontinuierlich auf den aktuellen Stand gehalten.
 Die Dokumentationsbeschreibung dieses Kapitels ist jedoch veraltet (initial, Jahr 2015) und muss überarbeitet werden.
...
:desc-table-webguianwendungshistorie: Historie der WebGui Anwendungsversionen
[id="table-webguianwendungshistorie",reftext="{table-caption} {counter:tables}"]
.{desc-table-webguianwendungshistorie}
|===
